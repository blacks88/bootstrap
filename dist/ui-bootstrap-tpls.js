...
angular.module('ui.bootstrap.datepicker').run(function() {!angular.$$csp().noInlineStyle && !angular.$$uibDatepickerCss && angular.element(document).find('head').prepend('<style type="text/css">.bootstrap-context .uib-datepicker .uib-title{width:100%;}.bootstrap-context .uib-day button,.uib-month button,.uib-year button{min-width:100%;}.bootstrap-context .uib-left,.bootstrap-context .uib-right{width:100%}</style>'); angular.$$uibDatepickerCss = true; });
